...
<head>
    ...
    <title>Job Openings & Career Opportunities at Aarav Tech Solutions</title>
    <meta name="description"
        content="Find all the job opportunities here and join one of the best digital marketing agency in USA & get excellent opportunities to achieve higher goals. Visit Now!">
    <link rel="canonical" href="https://aaravtechsolutions.com/career.php" />
    ...
    <div class="container-fluid header position-relative p-0">
        <nav class="navbar navbar-expand-lg fixed-top navbar-light px-lg-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                            ...
                            <div class="submenu-wrapper">
                                ...
                                <div class="submenu ">
                                    <a class="dropdown-item"
                                        ...
                                        Support</a>
                                    <a class="dropdown-item"
                                        href="https://aaravtechsolutions.com/call-center-services.html">Call
                                        Center Services</a>
                                </div>
                            </div>
                        </div>
                ...
                <a href="tel:" class="glass-btn nav-link-btn"
                    style="margin-right: 2rem; font-size: .8rem; padding:.8rem 1.6rem; width:fit-content;">Let's
                    Talk</a>
            </div>
        </nav>
        <!-- Hero Section -->
        <section class="hero">
            <div class="container hero-content">
                <h1>Build Your Career with <span class="gradient-text">Aarav Tech Solutions</span></h1>
                <p>Work and develop your career with a company that embraces innovation, teamwork and career advancement. The possibilities that we have are tremendous and multiple in terms of areas in which your abilities and visions can be useful. At Aarav Tech Solutions, a diverse culture is promoted in the workplace to promote learning, creativity and career growth. Whether you're experienced professional or a fresher, you will be given a good environment in which you can embrace your future. Discover the possibilities that we offer and start a passionate career in our company.</p>
                <div class="hero-buttons">
                    <a href="https://aaravtechsolutions.com/contact.html" class="btn-primary">Get Started <i
    ...
    <div class="career-section">
        <div class="container">
            <div class="career-intro">
                ...
                <h1>Innovate, Grow & Succeed With Us</h1>
                <p>At Aarav tech solutions, we have the culture of innovation, creativity and team spirit. We are continually seeking passionate and talented people, who are eager to bring a change. You are at the right place to work in as long as you are ready to grow your career and work on interesting projects.</p>
            ...
            <div class="row g-4">
                <div class="col-lg-6">
                    <div class="job-listing-card">
                        ...
                        <p>We’re scaling rapidly and need a business development professional who truly understands
                            digital marketing from end to end. You’ll be the driving force bringing in clients who need
                            SEO, PPC, SMM, web design, branding, and the whole digital ecosystem. No hand-holding. No
                            “we’ll give you leads.” You need your own network, sources, and hustle.</p>
                        <a href="https://in.linkedin.com/jobs/view/business-development-manager-at-aarav-tech-services-llp-4305209073?trk=public_post_feed-job-posting-content"
            ...
            <div class="text-center mt-5">
                <p class="fs-5" style="color: rgba(246, 246, 250, 0.8);">Didn't find a suitable position? Feel free to
                    send your resume to <a href="mailto:info@aaravtechsolutions.com"
                        style="color: var(--accent); font-weight: bold;">info@aaravtechsolutions.com</a>. We are always
                    on the
                    lookout for great talent!</p>
            </div>
        </div>
    </div>
