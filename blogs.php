...
<head>
    ...
    <title>Digital Marketing Blogs | SEO, Web Development & Growth Tips</title>
    <meta name="description"
        content="Explore expert blogs on SEO, digital marketing, web development, PPC & business growth strategies. Stay updated with actionable tips from Aarav Tech Solutions.">
    <link rel="canonical" href="https://aaravtechsolutions.com/blogs.php" />
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <div class="submenu-wrapper">
                                ...
                                <div class="submenu ">
                                    ...
                                    <a class="dropdown-item"
                                        href="https://aaravtechsolutions.com/ui-ux-design-services.html">UI/UX Design</a>
                                    <a class="dropdown-item"
                                        href="https://aaravtechsolutions.com/web-and-mobile-app-development.html">Web/Mobile App
                                        Development</a>
                                </div>
                            </div>
                            <div class="submenu-wrapper">
                                <a href="https://aaravtechsolutions.com/logo-design-services.html" class="dropdown-item">Logo
                                    Design</a>
                            </div>
                            <div class="submenu-wrapper">
                                <div class="dropdown-item submenu-parent">
                                ...
                                <div class="submenu ">
                                    <a class="dropdown-item"
                                        href="https://aaravtechsolutions.com/back-office-support-services.html">Back Office
                                        Support</a>
                                    <a class="dropdown-item" href="https://aaravtechsolutions.com/call-center-services.html">Call
                                        Centre Services</a>
                                </div>
                            </div>
                        </div>
        ...
        <section class="hero">
            <div class="container hero-content">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="https://aaravtechsolutions.com">Home</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Blogs</li>
                </ol>
                <h1 style="color:var(--bs-white)">Our<span class="gradient-text"> Blogs</span></h1>
                <p>A place where new ideas meet practical insights. Discover our blogs to keep you informed and
                    inspired.</p>
            </div>
        </section>
    </div>
    ...
    <section class="blog-section">
        <div class="container">
            <div class="section-title">
                ...
                <p>Unlock expert articles on marketing, design & technology. Learn what works, apply it & see results.
                </p>
            </div>
            ...
            <div class="blog-grid">
                ...
                <?php
                        ...
                        ?>
                <a class="blog-card" href="https://aaravtechsolutions.com/blogs/<?php echo $row['post_name']; ?>">
                    <?php if ($img_url): ?>
                    ...
                    <div class="blog-content">
                        <div class="blog-meta">
                            <span><i class="fas fa-calendar-alt"></i>
                                <?php echo date("F j, Y", strtotime($row['post_date'])); ?></span>
                        ...
                        <button href="https://aaravtechsolutions.com/blogs/<?php echo $row['post_name']; ?>"
                ...
                <div class="col-12 text-center">
                    <p style="color: rgba(246, 246, 250, 0.7); font-size: 18px;">No blogs found. Check back soon for new
                        articles!</p>
                </div>
                <?php endif; ?>
            </div>
