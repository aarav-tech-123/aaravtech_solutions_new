    ...
    <div class="container-fluid header position-relative p-0">
        <nav class="navbar navbar-expand-lg fixed-top navbar-light px-lg-5 py-3 py-lg-0">
            <a href="https://aaravtechsolutions.com" class="navbar-brand p-0">
                <img src="https://aaravtechsolutions.com/img/company_logo.png" alt="" id="toggleImg"
                        ...
                        <div class="dropdown-menu m-0">
                            <div class="submenu-wrapper">
                                <div class="dropdown-item submenu-parent">
                                    <a href="https://aaravtechsolutions.com/digital-marketing-services.html"
                                        class="submenu-link ">Digital Marketing</a>
                            ...
                            <div class="submenu-wrapper">
                                <div class="dropdown-item submenu-parent">
                                    <a href="https://aaravtechsolutions.com/web-development-services.html"
                                        class="submenu-link ">Web Development</a>
                                    <button class="submenu-toggle" type="button">
                                        <i class="fas fa-chevron-down"></i>
                                    </button>
                                </div>
                            ...
                            <div class="submenu-wrapper">
                                <div class="dropdown-item submenu-parent">
                                    <a href="https://aaravtechsolutions.com/bpo-services.html"
                                        class="submenu-link ">BPO</a>
                                    <button class="submenu-toggle" type="button">
                                        <i class="fas fa-chevron-down"></i>
                                    </button>
                                </div>
                                <div class="submenu ">
                                    <a class="dropdown-item"
                                        ...
                                        Office Support</a>
                                    <a class="dropdown-item"
                                        href="https://aaravtechsolutions.com/call-center-services.html">Call Centre
                                        Services</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="blog-slider-wrapper">
                    ...
                    ");
                        ...
                        <div class="blog-card">
                            ...
                            <?php endif; ?>
                            <div class="blog-content">
                                <p style="color:#c3c6d1;">
                                    <?php echo substr(strip_tags($row['post_content']), 0, 120); ?>...</p>
        ...
        <div class="container">
            <div class="cta-content">
                ...
                <div class="hero-buttons">
                    <a href="https://aaravtechsolutions.com/contact.html" class="btn-primary">Request a Quote <i
            ...
            <div class="footer-content">
                ...
                <div class="footer-column">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="https://aaravtechsolutions.com/about.html"><i class="fas fa-chevron-right"></i>
                                About Us</a></li>
                        <li><a href="https://aaravtechsolutions.com/blogs.php"><i class="fas fa-chevron-right"></i>
                                Blogs</a></li>
                        <!-- <li><a href="career.php"><i class="fas fa-chevron-right"></i>Career</a></li> -->
                        <li><a href="https://aaravtechsolutions.com/contact.html"><i class="fas fa-chevron-right"></i>
                                Contact</a></li>
                    </ul>
                </div>
                <div class="footer-column">
                    <h3>Our Services</h3>
                    <ul class="footer-links">
                        <li><a href="https://aaravtechsolutions.com/custom-website-development-services.html"><i
                                    class="fas fa-chevron-right"></i> Web
                                Development</a></li>
                        <li><a href="https://aaravtechsolutions.com/web-and-mobile-app-development.html"><i
                                    class="fas fa-chevron-right"></i> Web/Mobile
                                Apps</a></li>
                        <li><a href="https://aaravtechsolutions.com/graphic-designing.html"><i
                                    class="fas fa-chevron-right"></i>Graphic Designing</a>
                        </li>
                        <li><a href="https://aaravtechsolutions.com/digital-marketing-services.html"><i
                                    class="fas fa-chevron-right"></i> Digital
                                Marketing</a></li>
                        <li><a href="https://aaravtechsolutions.com/ui-ux-design-services.html"><i
                                    class="fas fa-chevron-right"></i> UI/UX Design</a>
                        </li>
                        <li><a href="https://aaravtechsolutions.com/bpo-services.html"><i
                                    class="fas fa-chevron-right"></i>BPO Services</a></li>
                    </ul>
                </div>
